...
public class ClientChat {
	...
	public String riceviMessaggio() {
		...
		try {
			...
			if (messaggio.compareTo("Spiacente, hai perso... Riconnettiti per giocare ancora") == 0
	...
	public void inviaMessaggio() {
		...
		try {
			do {
				...
				while (n < 4) {
					if (stringa[n].equals("0") || stringa[n].equals("1") || stringa[n].equals("2")
							|| stringa[n].equals("3") || stringa[n].equals("4") || stringa[n].equals("5")
							|| stringa[n].equals("6") || stringa[n].equals("7") || stringa[n].equals("8")
							|| stringa[n].equals("9")) {
					} else {
						validita = false;
					}
